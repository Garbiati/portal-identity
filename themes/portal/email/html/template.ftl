<#--
  LAYOUT compartilhado dos e-mails do Doctor Hub (rebranding 2026-07-05).
  ...
  - Cores da marca (tokens do app): navy #0E1B2E/#13233B · acento OURO #C6A052 (contraste no navy) ·
    ação primária = navy #13233B (texto branco 15:1). Links = navy-800 #13233B (AA sobre branco).
  ...
  <tr>
    <td align="center" style="padding:24px 12px;">
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; max-width:600px; background-color:#ffffff; border:1px solid #D5DEE6; border-radius:14px; overflow:hidden; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
        ...
        <#-- Cabeçalho / marca. NOTE(marca): "Doctor Hub" estilizado em duas cores direto aqui
             ("Doctor" branco + "Hub" em ouro #C6A052, 6.9:1 sobre o navy = AA). -->
        <tr>
          <td style="background-color:#0E1B2E; padding:26px 40px;">
            <span style="font-size:26px; font-weight:700; letter-spacing:-0.4px; color:#ffffff; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">Doctor&nbsp;<span style="color:#C6A052;">Hub</span></span>
            <div style="margin-top:5px; font-size:13px; color:#C3CCDA;">por ${msg("companyName")}</div>
          </td>
        </tr>

        <#-- Faixa fina de acento OURO da marca. -->
        <tr><td style="height:4px; line-height:4px; font-size:0; background-color:#C6A052;">&nbsp;</td></tr>
        ...
        <tr>
          <td style="padding:22px 40px 30px 40px; border-top:1px solid #E4EAF0; color:#51606E; font-size:12px; line-height:1.65; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            <strong style="color:#0E1B2E;">${msg("companyName")}</strong><br/>
            CNPJ ${msg("companyCnpj")} &nbsp;&middot;&nbsp; ${msg("companyAddress")}<br/>
            Suporte: <a href="mailto:${msg("supportEmail")}" style="color:#13233B; text-decoration:none;">${msg("supportEmail")}</a>
            &nbsp;&middot;&nbsp;
            <a href="${msg("companySite")}" style="color:#13233B; text-decoration:none;">${msg("companySite")}</a>
