...
<h1 style="margin:0 0 18px 0; font-size:22px; line-height:1.3; color:#0E1B2E; font-weight:700; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">Confirme seu e-mail</h1>

<p style="margin:0 0 16px 0;"><#if greetName?has_content>Olá, ${greetName},<#else>Olá,</#if></p>

<p style="margin:0 0 18px 0;">Para concluir a configuração do seu acesso ao <strong>Doctor Hub</strong>, confirme que este é o seu endereço de e-mail clicando no botão abaixo.</p>
