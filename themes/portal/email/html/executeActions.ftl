<#--
  ...
  É o e-mail que o admin dispara ao criar o acesso de alguém no Doctor Hub. O MAIS IMPORTANTE.
...
<h1 style="margin:0 0 18px 0; font-size:22px; line-height:1.3; color:#0E1B2E; font-weight:700; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">Bem-vindo(a) ao Doctor Hub</h1>

<p style="margin:0 0 16px 0;"><#if greetName?has_content>Olá, ${greetName},<#else>Olá,</#if></p>

<p style="margin:0 0 18px 0;">Você está recebendo este e-mail porque um administrador criou o seu acesso ao <strong>Doctor Hub</strong>. Para começar a usar, é só definir a sua senha.</p>

<#-- Caixa explicativa: o que é o Doctor Hub (legitimidade). -->
