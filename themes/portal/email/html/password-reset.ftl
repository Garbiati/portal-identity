<#--
  REDEFINIÇÃO DE SENHA (fluxo "esqueci a senha" iniciado pelo próprio usuário).
...
<p style="margin:0; font-size:14px; color:#51606E;">Se você não pediu para redefinir sua senha, ignore este e-mail — sua senha atual continua valendo e nada será alterado.</p>
